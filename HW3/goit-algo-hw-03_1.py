...
Для виконання сортування запустіть файл з вказівкою звідки брати файли для сортування та куди копіювати відсортовані
файли за допомогою наступної команди (python goit-algo-hw-03_1.py /path/to/source /path/to/destination)
"""
import os
import shutil
import argparse
